    ...
    <div class="row justify-content-center">
        <div class="col-md-10 p-5">
            <div class="card p-5">
                ...
                <div class="card-body">
                    <form method="POST" action="/savecreateprofile" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-md-6">
                                <input id="profile_picture_caption" type="text" class="form-control @error('profile_picture_caption') is-invalid @enderror" name="profile_picture_caption" value="{{ old('profile_picture_caption') }}"  autocomplete="profile_picture_caption">

                                @error('profile_picture_caption')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                ...
                <button><a href="/createcoverphoto">Add cover Photo</a></button>
            </div>
        </div>
    </div>
</div>
